...
function getEducationalFeedback(
  ...
  if (
    ...
    return `Baris 1 salah. umur bernilai ${umur} (bilangan bulat), jadi gunakan int.`;
  }
  ...
  if (
    ...
    return `Baris 2 salah. tinggi bernilai ${tinggi.toFixed(1)} (desimal), jadi gunakan float.`;
  }

  if (lineIdx === 2 && !trimmed.startsWith("char")) {
    return `Baris 3 salah. jenis_kelamin bernilai '${jenisKelamin}' (satu karakter), jadi gunakan char.`;
  }
  ...
  if (
    ...
    return "Baris 1 masih belum tepat. Pada soal ini kunci untuk umur adalah int.";
  }
...
export default function VariabelDataSiswaPage() {
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-gradient-to-br from-slate-50 via-cyan-50 to-indigo-50 text-foreground">
      <header className="z-40 flex shrink-0 items-center justify-between border-b border-cyan-100/80 bg-white/90 px-6 py-3 shadow-sm backdrop-blur">
        <div className="flex items-center gap-3">
          ...
          <div className="rounded-xl bg-gradient-to-br from-cyan-500 to-blue-600 p-2 text-white shadow-lg shadow-cyan-200/60">
            <Terminal size={20} />
          </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-cyan-100 bg-white px-5 py-2.5 text-xs font-bold transition-all duration-200 hover:bg-cyan-50"
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 rounded-xl px-5 py-2.5 text-xs font-bold uppercase tracking-wide transition-all duration-200 disabled:opacity-50 ${
              hasTried
                ? "border-2 border-cyan-300 bg-cyan-100 text-cyan-800"
          ...
          <button
            ...
            className={`flex items-center gap-2 rounded-xl px-6 py-2.5 text-xs font-bold uppercase tracking-wide transition-all duration-200 disabled:opacity-50 ${
              isRunning
                ...
                : "bg-gradient-to-br from-cyan-600 to-blue-600 text-white hover:from-blue-600 hover:to-cyan-600"
            }`}
          >
      ...
      <main className="flex flex-1 overflow-hidden">
        <aside className="z-20 flex w-72 shrink-0 flex-col gap-6 overflow-y-auto border-r border-cyan-100 bg-white/85 p-5 backdrop-blur">
          <div className="flex items-center gap-2">
            <BookOpen size={16} className="text-cyan-600/70" />
          ...
          <div className="mt-auto rounded-2xl border border-cyan-200/80 bg-cyan-50/80 p-4">
            <div className="mb-2 flex items-center justify-between text-[9px] font-black uppercase text-cyan-700">
        ...
        <div className="flex min-w-0 flex-1 flex-col bg-transparent">
          <section className="px-6 pb-2 pt-4">
            <div className="flex items-start gap-4 rounded-2xl border border-cyan-200 bg-gradient-to-r from-cyan-50 to-blue-50 p-4 shadow-sm">
              <div className="rounded-xl bg-white p-2 text-cyan-700 shadow-sm">
                <Lightbulb size={20} className="animate-pulse" />
              </div>
              <div className="flex-1">
                <div className="mb-1 flex items-center gap-2">
                  <span className="rounded bg-cyan-700 px-2 py-0.5 text-[9px] font-black uppercase tracking-widest text-white">
                    MISI
                  </span>
            ...
            {showSuccessCard && (
              ...
              >
                <div className="rounded-2xl border border-cyan-200 bg-white px-4 py-3 shadow-sm">
                  <h3 className="text-sm font-black tracking-tight text-cyan-700">
          ...
          <div className="flex flex-1 gap-5 overflow-hidden px-6 pb-6">
            <section className="relative flex min-w-[500px] flex-1 flex-col overflow-hidden rounded-3xl border border-cyan-100 bg-white shadow-sm">
              <div className="flex items-center justify-between border-b border-cyan-100 bg-cyan-50/60 px-5 py-3">
                <div className="flex items-center gap-3">
                  <div
              ...
              <div className="relative flex flex-1 overflow-hidden font-mono text-[13px] leading-[26px]">
                  ...
                  {Array.from({ length: totalDisplayLines }).map((_, i) => (
                    <div
                      ...
                      className={`h-[26px] transition-all ${
                        activeLine === i
                          ? "scale-110 pr-1 font-black text-cyan-700"
                          : ""
                      }`}
                    >
                      {i + 1}
                ...
                <div className="relative flex-1 overflow-hidden bg-card">
                  ...
                  {openSelectorLine !== null && !isRunning && (
                    <div className="absolute bottom-4 left-5 right-5 z-30 rounded-xl border border-cyan-200 bg-white px-3 py-2 shadow-lg">
                      <p className="mb-2 text-[10px] font-black uppercase tracking-widest text-cyan-700">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <button
                          ...
                          className="rounded-lg border border-cyan-300 bg-cyan-50 px-3 py-1.5 text-[10px] font-black uppercase tracking-wide text-cyan-700 hover:bg-cyan-100"
                        >
                          INT
                        </button>
                        <button
            ...
            <aside className="relative flex w-[380px] shrink-0 flex-col overflow-hidden rounded-3xl border border-cyan-400/40 bg-gradient-to-br from-[#05283d] via-[#0b3653] to-[#132445] shadow-2xl">
              <div className="flex items-center justify-between border-b border-cyan-300/30 bg-cyan-900/20 px-6 py-4">
                <h2 className="text-[10px] font-black uppercase tracking-widest text-cyan-100">
                  DASHBOARD SISWA
                </h2>
                <div
              ...
              <div className="relative flex flex-1 flex-col items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_center,_#1f4b6b_0%,_#0f2742_100%)] p-6">
                <div className="absolute -left-10 -top-8 h-32 w-32 rounded-full bg-cyan-300/20 blur-2xl" />
                <div className="absolute -right-10 top-8 h-28 w-28 rounded-full bg-blue-400/20 blur-2xl" />
                ...
                >
                  <AnimatePresence>
                    {isMismatchVisual && (
                      ...
                      >
                        <div className="absolute left-8 top-5 h-9 w-9 rounded-full bg-cyan-300/25 blur-md" />
                        <div className="absolute right-8 top-6 h-8 w-8 rounded-full bg-indigo-300/25 blur-md" />
                        ...
                        {(isMismatchInt || isMismatchShort) && (
                          <motion.div
                            ...
                            className="absolute inset-x-10 top-[42%] h-12 rounded-lg border-2 border-dashed border-cyan-300/45"
                          />
                        )}
                      </motion.div>
                    )}
                  ...
                  <div className="absolute inset-x-3 top-4 rounded-2xl border border-cyan-200/30 bg-cyan-900/35 px-4 py-2">
                    <div className="flex items-center justify-between">
                      <p className="text-[9px] font-black tracking-[0.16em] text-cyan-100">
                        PAPAN ABSENSI
                      </p>
                      <p className="text-[9px] font-black tracking-[0.16em] text-cyan-200/80">
                        KELAS IX-A
                      </p>
                    </div>
                  </div>

                  <div className="absolute inset-x-3 bottom-3 top-[54px] rounded-2xl border border-cyan-200/35 bg-gradient-to-b from-[#1d3f66]/70 via-[#152f50]/75 to-[#0b213b]/85 p-3 shadow-[0_18px_34px_rgba(0,0,0,0.45)]">
                        ...
                        return (
                          <motion.div
                            ...
                            className={`relative rounded-xl border p-1.5 ${
                              isMismatchVisual
                                ? "border-cyan-200/45 bg-slate-900/55"
                                : "border-cyan-200/30 bg-slate-900/45"
                            }`}
                          >
                            <div className="flex items-center gap-1">
                              <span className="inline-flex h-6 w-6 items-center justify-center rounded-md bg-cyan-100/15 text-sm">
                                {avatar}
                              </span>
                              <div className="min-w-0">
                                <p className="truncate text-[8px] font-black tracking-wide text-cyan-100">
                                  SISWA {i + 1}
                                </p>
                                <p className="text-[8px] font-bold text-cyan-200/80">
                                  {studentData.jenisKelamin || "-"}
                                </p>
                              </div>
                            </div>

                            <div className="mt-1 flex items-center justify-between text-[8px] font-black text-cyan-50/90">
                            ...
                            {isMismatchVisual && isMismatchFloat && (
                              <span className="absolute -right-1 -top-1 rounded-full bg-cyan-300 px-1 text-[8px] font-black text-cyan-900">
                                {
                                  FLOAT_DECIMAL_FRUITS[
